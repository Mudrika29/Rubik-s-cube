...
const char* s = "1.) Use your mouse to click and rotate the entire cube";
const char* s1 = "2.) Character keys to rotate cube slices: q, a, w, s, e, d, r, f, t, g, y, h";
const char* s2 = "3.) Use character key 'o' to solve the cube.";
const char* s3 = "4.) Use symbol keys '+' and '-' to increase/decrease speed of rotations";
const char* s4 = "5.) Use character key 'z' to zoom in and character key 'x' to zoom out";
